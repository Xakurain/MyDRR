...
def initialize_projector(Projector_info, model_filepath="F:\\dataset\\imia\\zyt303_1\\303 Calf_0.nii.gz", maskFileName=None, ClassWeights=[1.0,1.0,1.0]):
